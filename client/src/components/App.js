...
import PhotoWrite from "./views/Board/WritePage/PhotoWrite";
  ...
  return (
    <SnackbarProvider> 
      <MuiThemeProvider theme={theme}>
        <div style={{width: '100%', minHeight: 'calc(100vh + 80px)', backgroundColor: blueGrey[900], color: 'white'}}>
        <Suspense fallback={(<div>Loading...</div>)}>
          <div style={{ width: '75%', margin: '0 auto 0 auto', minHeight: 'calc(100vh + 80px)', backgroundColor: blueGrey[900] }}>
            <Header />
            <div style={{ display: 'flex', minHeight: '100%', backgroundColor: blueGrey[900] }}>
              <Navbar />
              <div style={{ width: '65%', minHeight: '100%', margin: '0 auto', backgroundColor: blueGrey[800] }}>
                <Switch>
                  ...
                  <Route exact path="/board/photo/write" component={Auth(PhotoWrite, true)} />
